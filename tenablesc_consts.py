...
TENABLE_UNICODE_DAMMIT_TYPE_ERROR_MESSAGE = "Error occurred while connecting to the QRadar server. Please check the asset configuration and|or the action parameters."
